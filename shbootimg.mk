...
TARGET_KERNEL_BINARIES: $(PRODUCT_OUT)/ramdisk-recovery.cpio $(uncompressed_ramdisk) $(PRODUCT_OUT)/utilities/flash_image $(PRODUCT_OUT)/symbols/utilities/make_ext4fs $(PRODUCT_OUT)/utilities/erase_image $(PRODUCT_OUT)/utilities/bml_over_mtd
