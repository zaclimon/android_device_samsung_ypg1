...
TARGET_KERNEL_BINARIES: $(uncompressed_ramdisk) $(PRODUCT_OUT)/flash_image $(PRODUCT_OUT)/symbols/utilities/make_ext4fs $(PRODUCT_OUT)/erase_image $(PRODUCT_OUT)/bml_over_mtd
